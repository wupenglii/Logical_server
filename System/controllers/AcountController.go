...
import (
	...
	"Logical_server/System/common"
	"Logical_server/System/models"
	"Logical_server/System/utils"
	...
	if cookie, ok := c.GetSecureCookie(common.AppKey(), "login"); ok {
		if err := utils.Decode(cookie, &remember); err == nil {
			if err = c.login(remember.MemberId); err == nil {
				c.Redirect(beego.URLFor("HomeController.Index"), 320)
				return
			}
		}
	}
